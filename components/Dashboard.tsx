...
import { Task, ProgressStats, SubjectName, SubjectStats, AnalyzedTopic, TaskType, TestPlan } from '../types';
                        ...
                        return (
                            <div key={task.id} className={cn(
                                ...
                                isTestPrepTask 
                                    ...
                                    : "bg-black/30 border-brand-cyan-700"
                            )}>
                        ...
                        {Object.entries(subjectStats.chapters).filter(([,data]) => hasData(data)).map(([chapterName, chapterData]) => {
                            ...
                            return (
                                <React.Fragment key={chapterName}>
                                    <tr className={cn("border-b border-white/10 bg-white/5 cursor-pointer", chapterAvgScore > 0 && getScoreBgClass(chapterAvgScore))} onClick={() => toggleExpand(chapterName)}>
...
const Dashboard: React.FC = () => {
    ...
    return (
        <div className="space-y-8">
            ...
            <div>
                <div className="border-b border-white/20 flex space-x-1">
                    {subjectTabs.map(tab => (
                        <button
                            key={tab.name}
                            ...
                            className={cn(
                                ...
                                activeTab === tab.name
                                    ? 'bg-white/10 text-brand-cyan-400 border-b-2 border-brand-cyan-400'
